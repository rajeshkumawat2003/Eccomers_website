                            ...
                            <h1 class="mb10">Manage Category</h1>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <form Action="/update/category/{{$post->id}}" method="post" enctype="multipart/form-data">
                                        @csrf  
                                            <div class="form-group">
                                                <label for="category_name" class="control-label mb-1">Category Name</label>
                                                <input id="category_name" type="text" name="category_name" value="{{$post->category_name}}" class="form-control" aria-required="true" aria-invalid="false">
                                            </div>
                                            <div class="form-group has-success">
                                                <label for="tatal_product" class="control-label mb-1">Total Product</label>
                                                <input id="tatal_product" name="tatal_product" type="text" value="{{$post->tatal_product}}" class="form-control cc-name valid" data-val="true" data-val-required="Please enter the name on card"
