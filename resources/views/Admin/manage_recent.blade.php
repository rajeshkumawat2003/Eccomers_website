                            ...
                            <h1 class="mb10">Manage Product</h1>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <form action="{{route('recent.manage_recent_process')}}" method="post" enctype="multipart/form-data">
                                        @csrf  
                                            ...
                                            <div class="form-group has-success">
                                                ...
                                                <input id="price" name="price" type="text" class="form-control cc-name valid" data-val="true" data-val-required="Please enter the name on card"
