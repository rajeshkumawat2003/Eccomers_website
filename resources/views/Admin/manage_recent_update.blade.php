                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <h1 class="mb10">Manage product</h1>
                                 <a href="{{url('admin/recent')}}" class="d-flex justify-content-end">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <form Action="/update/recent/{{$post->id}}" method="post" enctype="multipart/form-data">
                                        @csrf  
                                            <div class="form-group">
                                                <label for="product_name" class="control-label mb-1">Category Name</label>
                                            ...
                                            <div class="form-group has-success">
                                                <label for="price" class="control-label mb-1">Total Product</label>
                                                <input id="price" name="price" type="text" value="{{$post->price}}" class="form-control cc-name valid" data-val="true" data-val-required="Please enter the name on card"
