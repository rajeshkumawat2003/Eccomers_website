...
<head>
    ...
    <link href="{{asset('Admin_asset/vendor/vector-map/jqvmap.min.css')}}" rel="stylesheet" media="all">
...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar2">
            <div class="logo">
                <a href="#">
                    <img src="{{asset('Admin_asset/images/icon/logo-white.png')}}" alt="Cool Admin" />
                </a>
            </div>
            <div class="menu-sidebar2__content js-scrollbar1">
                <div class="account2">
                    <div class="image img-cir img-120">
                        <img src="{{asset('Admin_asset/images/icon/avatar-big-01.jpg')}}" alt="John Doe" />
                    </div>
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="{{url('admin/category')}}">
                                        <i class="fab fa-flickr"></i>Categary</a>
                                </li>
                                <li>
                                        <a href="{{url('admin/product')}}">
                                            <i class="fab fa-flickr"></i>product</a>
                                    </li>
                                <li>
                                        <a href="{{url('admin/slider')}}">
                                            <i class="fab fa-flickr"></i>slider</a>
                                    </li>
                                    <li>
                                        <a href="{{url('admin/recent')}}">
                                            <i class="fab fa-flickr"></i>Recent Product</a>
                                    </li>
                        ...
                        <ul class="list-unstyled navbar__list">
                            ...
                            <li class="has-sub">
                                ...
                                <ul class="list-unstyled navbar__sub-list js-sub-list">
                                    <li>
                                        <a href="{{url('admin/category')}}">
                                            <i class="fab fa-flickr"></i>Catgries</a>
                                    </li>
                                    <li>
                                        <a href="{{url('admin/category')}}">
                                            <i class="fab fa-flickr"></i>product</a>
...
@show
    ...
    <script src="{{asset('Admin_asset/vendor/vector-map/jquery.vmap.js')}}"></script>
    <script src="{{asset('Admin_asset/vendor/vector-map/jquery.vmap.min.js')}}"></script>
    <script src="{{asset('Admin_asset/vendor/vector-map/jquery.vmap.sampledata.js')}}"></script>
    <script src="{{asset('Admin_asset/vendor/vector-map/jquery.vmap.world.js')}}"></script>
