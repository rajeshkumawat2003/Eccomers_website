        ...
        <div class="row bg-secondary py-1 px-xl-5">
            ...
            <div class="col-lg-6 text-center text-lg-right">
                <div class="d-inline-flex align-items-center">
                    @if(Session::has('user'))
                    <div class="btn-group">
                        <button type="button" class="btn btn-sm btn-light dropdown-toggle" data-toggle="dropdown">{{Session::get('user')['email']}}</button>
                        <div class="dropdown-menu dropdown-menu-right">
                       <a href="{{url('/logout')}}"><button class="dropdown-item" type="button">logout</button></a>
                        </div>
                    </div>   
                    @else
                    <a href="{{url('/login')}}"><button class="dropdown-item" type="button">login in</button></a>
